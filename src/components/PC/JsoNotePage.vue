<template>
  <div>
    <div class="contentXPage" v-if="isInit">
      <div class="content-menu" v-if="!isSimple" :class="isDeep ? 'deep' : 'light'">
        <div class="content-menu-ad" v-if="!isDeep">
          <div class="content-menu-ad-item" v-for="item in config.ads">
      ...
      <div class="content-main" :style="{ 'padding': isSimple ? '2rem 333px' : (!isDeep ? '2rem' : '2rem 2rem 2rem 333px'), 'padding-left': ((!isDeep && !isSimple) ? '2rem' : '333px') }">
...
<script>
  ...
  import JNsAdCard from '../Common/static/JNsAdCard.vue'
